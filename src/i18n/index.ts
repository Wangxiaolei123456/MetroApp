...
const zh = {
  ...
  'wallet.mainnet': '主网',
  'wallet.refresh': '刷新',
  'wallet.address': '钱包地址（D2 已绑定账户）',
  'wallet.tokenBalance': 'Token 余额',
  'wallet.nfts': 'NFT 持仓',
  'wallet.noNft': '暂无 NFT',
  'wallet.txs': '交易记录',
  'wallet.noTx': '暂无交易',
  ...
  'svc.loc.permMsg': 'MetroChain 需要定位权限，以规划从你当前位置出发的路线，并实时显示你在地铁站的位置。',
  'svc.loc.allow': '允许',
  'svc.loc.deny': '拒绝',
  'svc.loc.later': '稍后询问',
  'svc.loc.neverAsk': '定位权限被永久拒绝，请在系统设置 → 应用 → MetroChain → 权限 中开启"位置信息"后重试',
...
const en: Record<TKey, string> = {
  ...
  'wallet.address': 'Wallet address (D2 bound account)',
  ...
  'svc.loc.permMsg': 'MetroChain needs location access to plan routes from your current position and show your position in metro stations.',
  'svc.loc.allow': 'Allow',
  'svc.loc.deny': 'Deny',
  'svc.loc.later': 'Ask later',
  'svc.loc.neverAsk': 'Location permission permanently denied. Enable "Location" in Settings → Apps → MetroChain → Permissions and retry.',
